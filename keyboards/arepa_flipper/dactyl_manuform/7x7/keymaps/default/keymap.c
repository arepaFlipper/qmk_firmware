...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_BRID,LSFT(KC_BSLS), KC_Z   , KC_X  , KC_C  , KC_V  , KC_B  ,
                                                                    KC_N  , KC_M   , KC_COMM, KC_DOT, KC_SLSH, KC_PGUP  , C(KC_TAB),
        KC_LGUI, C(KC_LALT) , C(KC_LGUI)  , KC_HOME  , KC_END  , KC_SPC  , KC_LSFT  ,
                                                            KC_RSFT, LT(DIRECTIONS, KC_SPC)  , LSFT(KC_LBRC)   , LSFT(KC_RBRC), RCTL(KC_B), KC_PGDN, C(KC_B),
    ...
    [_DIRECTIONS] = LAYOUT(
        ...
        KC_BRID,LSFT(KC_BSLS), KC_Z   , KC_X  , KC_C  , KC_V  , KC_B  ,
                                                                    KC_N  , KC_M   , LSFT(KC_COMM), RSFT(KC_DOT), KC_SLSH, KC_LCTL  , KC_RCTL,
        KC_LGUI, KC_LCTL , KC_LALT   , LSFT(KC_COMM)  , LSFT(KC_DOT)  , DIRECTIONS  , KC_LSFT  ,
                                                                    LOWER, KC_SPC  , LSFT(KC_LBRC)   , C(S(KC_END)), KC_RALT, KC_SLSH, LSFT(KC_B),
